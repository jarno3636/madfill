          ...
          <CardContent className="text-sm space-y-1">
            {debug.error 
              ...
              : <>
                  ...
                  <p><strong>Started event IDs:</strong> {debug.startedIds.join(', ') || '—'}</p>
                  <p><strong>Paid event IDs:</strong> {debug.paidIds.join(', ') || '—'}</p>
                  <p><strong>Open Round IDs:</strong> {debug.openIds.join(', ') || '—'}</p>
                </>
            }
          </CardContent>
        </Card>
