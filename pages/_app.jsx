...
import { WalletProvider } from '@/components/WalletProvider'   // ⬅️ add back
...
export default function App({ Component, pageProps }) {
  ...
  useEffect(() => {
    ...
    const onError = (e) => { try { window.gtag?.('event','exception',{ description: e?.error ? String(e.error) : String(e?.message), fatal:false }) } catch {} }
    const onRejection = (e) => { try { window.gtag?.('event','exception',{ description: 'Unhandled Promise Rejection: ' + String(e?.reason), fatal:false }) } catch {} }
